...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Admin Login — Kamali Architects</title>
    ...
    <body class="min-h-screen bg-dark text-cream">
        <div class="min-h-screen flex items-center justify-center px-5">
            <div class="w-full max-w-md rounded-2xl border border-cream/10 bg-dark/55 backdrop-blur p-8">
                ...
                <h1 class="mt-6 font-display text-3xl">Sign in</h1>
                <p class="mt-2 text-sm text-cream/70">Use your admin credentials to manage the site.</p>
                ...
                <form class="mt-6 grid gap-5" method="post" action="{{ route('admin.login.submit') }}">
                    @csrf
                    <div>
                    ...
                    <div>
                        <label class="label text-cream/60" for="password">Password</label>
                    ...
                    <div class="flex items-center justify-between">
                        <label class="inline-flex items-center gap-3 text-sm text-cream/70">
                            <input type="checkbox" name="remember" class="h-4 w-4 rounded border-cream/20 bg-dark/40" />
                            Remember me
                        </label>
                        <a class="text-sm text-cream/70 hover:text-cream" href="{{ route('admin.password.request') }}">Forgot password?</a>
                    </div>
